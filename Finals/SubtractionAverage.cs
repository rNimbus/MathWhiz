...
{
	/// <summary>
	/// Description of SubtractionAverage.
	/// </summary>
	public partial class SubtractionAverage : Form
	{
		...
		public string gameMode = "Subtraction";
		...
		public SubtractionAverage(User user, List<User> userList, string difficulty)
		{
			InitializeComponent();
			random = new Random();
			currentUser = user;
		...
		public void RandomGen(){
		    ...
		    int num2val = random.Next(11, 29);
		    int tonotEq = random.Next(11, 29);
		    if (num1val >= num2val){
		    	if(num1val == num2val){
		    		num1val = random.Next(num2val+tonotEq,num2val+tonotEq);
