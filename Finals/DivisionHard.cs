...
{
	/// <summary>
	/// Description of DivisionHard.
	/// </summary>
	public partial class DivisionHard : Form
	{
		...
		public DivisionHard(User user, List<User> userList, string difficulty)
		{
			InitializeComponent();
			random = new Random();
			currentUser = user;
		...
		public void RandomGen(){
	        int num1val = random.Next(100, 1000);
		    int num2val = random.Next(1, 100);
		    
		    while (num1val % num2val != 0)
		    {
		        num1val = random.Next(100, 1000);
		        num2val = random.Next(1, 100);
  			}
