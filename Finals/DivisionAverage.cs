...
{
	/// <summary>
	/// Description of DivisionAverage.
	/// </summary>
	public partial class DivisionAverage : Form
	{
		...
		public DivisionAverage(User user, List<User> userList, string difficulty)
		{
			InitializeComponent();
			random = new Random();
			currentUser = user;
		...
		public void RandomGen(){
	        int num1val = random.Next(20, 100);
		    int num2val = random.Next(10, 20);
		   
		    
		    while (num1val % num2val != 0)
		    {
		        num1val = random.Next(20, 200);
		        num2val = random.Next(10, 20);
  			}
