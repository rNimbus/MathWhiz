...
{
	/// <summary>
	/// Description of SubtractionEasy.
	/// </summary>
	public partial class SubtractionEasy : Form
	{
		...
		public SubtractionEasy(User user, List<User> userList, string difficulty)
		{
			InitializeComponent();
			random = new Random();
			currentUser = user;
		...
		public void RandomGen(){
	        int num1val = random.Next(1, 19);
		    int num2val = random.Next(1, 9);
		    int tonotEq = random.Next(1, 9);
		    if (num1val >= num2val){
		    	if(num1val == num2val){
