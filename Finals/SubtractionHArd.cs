...
namespace Finals
{
	...
	public partial class SubtractionHArd : Form
	{ 
		...
		public SubtractionHArd(User user, List<User> userList, string difficulty)
		{
			InitializeComponent();
			random = new Random();
			currentUser = user;
		...
		public void RandomGen(){
	        int num1val = random.Next(99, 999);
		    int num2val = random.Next(99, 999);
		    int tonotEq = random.Next(99, 999);
		    if (num1val >= num2val){
		    	if(num1val == num2val){
