...
{
	/// <summary>
	/// Description of MultiplicationAverage.
	/// </summary>
	public partial class MultiplicationAverage : Form
	{
		...
		public string difficulty = "Average";
		...
		public MultiplicationAverage(User user, List<User> userList, string difficulty)
		{
			InitializeComponent();
			random = new Random();
			currentUser = user;
